...
| `cargo test --workspace` — 531 tests | 5 min |
...
extract-parameter | extract-field | encapsulate-field | wrap-return | make-static | invert-boolean | generify | hover | def | refs | callers | callees |
