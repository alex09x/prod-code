...
**Where it stands** (v0.3.4, 2026-09-24): 55 MCP tools, a cluster of three Linux nodes and a
...
cover TypeScript, Python and Go, and are open for C/C++ and Swift. Partial: caches shared across worktrees beyond the C/C++ compiler cache — the
